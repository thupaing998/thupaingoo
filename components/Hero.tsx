...
export default function Hero() {
  ...
  return (
    <section ref={ref} id="hero" className="relative min-h-screen flex items-center overflow-hidden bg-white/50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-32 pb-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            {/* Status badge */}
            <motion.div variants={stagger.item} className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-emerald-50/80 backdrop-blur-sm border border-emerald-200/50 mb-8 shadow-sm">
              ...
              <div className="flex flex-wrap overflow-hidden pb-2">
                {nameWords.map((word, i) => (
                  <motion.span 
                    ...
                    className="mr-3 sm:mr-4 inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-600 via-brand-500 to-violet-500"
                  >
                    {word}
                  </motion.span>
                ))}
            ...
            <motion.div variants={stagger.item} className="flex flex-wrap items-center gap-4 mb-12">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#projects" 
                className="btn-primary text-base px-8 py-3.5 rounded-xl bg-ink text-white border-transparent hover:bg-ink-soft hover:border-transparent group"
              >
                Explore Work
                <motion.span 
              ...
              <motion.a 
                ...
                className="btn-outline text-base px-8 py-3.5 rounded-xl border-2 border-surface-border text-ink hover:text-ink font-semibold"
              >
                Let's Talk
              </motion.a>
            </motion.div>
        ...
        >
          {stats.map(({ value, label }) => (
            ...
            >
              <div className="font-display text-4xl sm:text-5xl font-black text-ink mb-2 group-hover:scale-110 group-hover:text-brand-600 transition-all origin-left">
                {value}
              </div>
